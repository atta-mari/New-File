...
namespace Sindh_University_Transport_MS.Controllers
{
    public class AreasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,CityId")] Area area)
        {
            ...
            ViewBag.CityId = new SelectList(db.Cities, "Id", "Name", area.CityId);
            return View(area);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,CityId")] Area area)
        {
            if (ModelState.IsValid)
            {
